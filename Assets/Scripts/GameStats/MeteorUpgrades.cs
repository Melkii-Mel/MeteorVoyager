...
{
    [Serializable]
    public class MeteorUpgrades : IGameStats, IDeletableOnRelocation
    {
        public string FileName { get; } = nameof(MeteorUpgrades);
        public static MeteorUpgrades Instance { get; } = new MeteorUpgrades();
